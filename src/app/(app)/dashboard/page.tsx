...
export default function DashboardPage() {
  ...
  }, [addToast, setTitulos, setClientes, setDisparos, setRecebimentos]);

  // Auto-load ao entrar na página
  useEffect(() => {
    carregarDados();
  }, [carregarDados]);

  // Label dinâmico do período selecionado
  ...
  return (
    ...
    <div style={{ maxWidth: 1300 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: "#64748B", fontSize: 13, marginTop: 4 }}>Visão geral da carteira de cobrança — {labelPeriodo}</p>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: 16, marginBottom: 16 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 14, padding: "20px 24px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", border: "1px solid #F1F5F9" }}>
          ...
          <div style={{ fontWeight: 700, fontSize: 14, color: "#0F172A", marginBottom: 16 }}>Evolução da Carteira ({labelPeriodo})</div>
